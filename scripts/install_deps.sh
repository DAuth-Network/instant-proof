...
# SGX PSW package
sgxpswlibs=(
    libsgx-ae-epid=2.18.100.3-jammy1 \
    libsgx-ae-le=2.18.100.3-jammy1 \
    libsgx-ae-pce=2.18.100.3-jammy1 \
    libsgx-ae-qe3=1.15.100.3-jammy1 \
    libsgx-aesm-ecdsa-plugin=2.18.100.3-jammy1 \
    libsgx-aesm-epid-plugin=2.18.100.3-jammy1 
    libsgx-aesm-launch-plugin=2.18.100.3-jammy1 \
    libsgx-aesm-pce-plugin=2.18.100.3-jammy1 
    libsgx-aesm-quote-ex-plugin=2.18.100.3-jammy1 \
    libsgx-enclave-common=2.18.100.3-jammy1 
    libsgx-epid=2.18.100.3-jammy1 \
    libsgx-launch=2.18.100.3-jammy1 \
    libsgx-pce-logic=1.15.100.3-jammy1 \
    libsgx-qe3-logic=1.15.100.3-jammy1 \
    libsgx-quote-ex=2.18.100.3-jammy1 \
    libsgx-urts=2.18.100.3-jammy1 \
    libsgx-uae-service=2.18.100.3-jammy1 \
    sgx-aesm-service=2.18.100.3-jammy1)
# SGX prerequisites
